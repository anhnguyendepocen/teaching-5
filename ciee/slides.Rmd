...
shifts from acute, short-term disruptions to latent,
long-term decline.
...
```{r heatmap, echo = FALSE, fig.align = 'center', fig.width = 4, fig.height = 4/1.5, warning = FALSE}
# === Heatmap for physint ==================================
...
```{r interactionTerm, echo = FALSE, fig.align = 'center', fig.width = 4, fig.height = 4/1.618, results = FALSE, warning = FALSE}

...
- übertragen politische Positionen in euklidische Räumen,
...
3. Eingipfeligkeit von Präferenzen (Single-peakedness)
    ...
    - oft: Symmetrie ($||y_i - o_r|| = ||y_i - o_s|| \implies u_i(o_r) = u_i(o_s)$)
...
\begin{columns}
    \begin{column}{.5\textwidth}
        \textbf{Gewinnmenge}
        \begin{itemize}
            \item alle Punkte, die bei geltender \textit{Entscheidungsregel} einen \textit{Referenzpunkt} besiegen können

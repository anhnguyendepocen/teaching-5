...
Das Antezedens ist in der Regel \textcolor{gray}{unsicher}: Prima facie wissen
wir nicht, ob unsere Theorien wahr sind. Beobachtungsdaten erlauben es aber,
Rückschlüsse über das Antezedenz zu ziehen.
...
\textbf{Achtung}: Ein \textit{naiver} Falsifikationismus weist das
Antezedens bei falscher Konsequenz zurück. Ein \textit{raffinierter}
Falsifikationismus erkennt an, dass die Falschheit der Konsequenz andere
Ursachen haben kann, z.\,B. Messfehler, probabilistische Kausalität, etc.

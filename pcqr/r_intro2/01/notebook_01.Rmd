...
Finally, *R* ships with an extensive online documentation. For instance, it includes a manual named ``An Introduction to R''.[^1] Use the RStudio help pane to locate this manual.


## What is an object?

*R* stores data in objects. When encountering an object, *R* returns the data saved inside.
...
*R* uses functions to operate on data. The data passed to a function is called its argument. Execute the following commands and describe the result.

...
[^1]: The title doesn't say "gentle". Kabacoff, Robert I. (XXXX). *R in Action*. Data Anaysis and Graphics With R. 2$^{nd}$ ed. Manning Publications: Shelter Island, NY, and Kosuke, Imai (XXXX). *Quantitative Social Science*. Cambridge Universtiy Press: Cambdridge are most gentle introductions. 
